...
var uploadTools = {
     ...
     */
     "initWithLayout":function(opt){
        ...
        btsStr += "<div class='selectFileBt'>";
        btsStr += "<img src='../img/fabiaopingjia_tianjiatupian.png'>";
        btsStr += "</div>";
...
//      modelStr+="<div class='imgShow'>";
        modelStr += "<div class='pic_delete'onclick='delImg(this)'>";
        modelStr += "<img src='../img/shangpinxiangqing_quxiao.png'>";
        modelStr += "</div>";
